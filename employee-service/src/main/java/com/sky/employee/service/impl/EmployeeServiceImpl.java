...
import com.sky.gateway.utils.common.constant.PasswordConstant;
import com.sky.gateway.utils.common.constant.StatusConstant;
import com.sky.gateway.utils.common.context.BaseContext;
import com.sky.gateway.utils.common.exception.AccountLockedException;
import com.sky.gateway.utils.common.exception.AccountNotFoundException;
import com.sky.gateway.utils.common.exception.PasswordErrorException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void updatePassword(PasswordEditDTO passwordEditDTO) {
        ...
        if(byId==null) throw new AccountNotFoundException(MessageConstant.ACCOUNT_NOT_FOUND);
        else {
            if(byId.getPassword().equals(DigestUtils.md5DigestAsHex(passwordEditDTO.getOldPassword().getBytes()))){
            byId.setPassword(DigestUtils.md5DigestAsHex(passwordEditDTO.getNewPassword().getBytes()));
            employeeMapper.updateInfo(byId);
